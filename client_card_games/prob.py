...
class Game:
    ...
    def create_interface(self):
        ...
        shared, player_cards, self.player_points, dealer_cards, self.dealer_points = json.loads(
            sock.recv(1024).decode('utf-8'))
        self.shared_cards = cards.SpriteCards(shared, 1100, 350, 2, open_cards=False).cards
    ...
    def round_game(self):
        ...
        while running:
            ...
            self.draw_button = cards.Button(550, 650, 'draw', black)
            self.pass_button = cards.Button(700, 650, 'Pass', black)
            menu_sprite = pygame.sprite.Group(self.draw_button, self.pass_button, point_player_result, point_dealer_result)
